...
{
    public class PermissionsExistsRetrievalPolicyTests
    {
        private PermissionExistsRetrievalPolicy _policy;

        public PermissionsExistsRetrievalPolicyTests()
        {
            _policy = new PermissionExistsRetrievalPolicy();
        }
